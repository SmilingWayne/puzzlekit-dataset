...
SITE = "https://www.puzzle-bridges.com"
REPO_ROOT = TOOLS_DIR.parent.parent
OUTPUT_DIR = REPO_ROOT / "assets" / "data" / "Hashi"
DEFAULT_SIZES = [2, 4, 5, 7, 8, 10, 11, 12, 13, 14, 17, 18]
...
EXPECTED_DIMS = {
    ...
    10: (25, 25),
    11: (25, 25),
    12: (30, 40),  # weekly special; may vary
    13: (30, 30),  # daily special; may vary
    14: (40, 50),  # monthly special; may vary
    17: (15, 15),
    18: (25, 25),
}
...
SPEC = ScraperSpec(
    name="Hashi",
    site=SITE,
    file_prefix="Hashi_dataset",
    default_sizes=DEFAULT_SIZES,
    output_dir=OUTPUT_DIR,
    description="Scrape puzzle-bridges.com Hashi puzzles into a rolling JSON store.",
)
...
def decode_task(task: str) -> list[str]:
    """Decode Hashi task strings: digits are island clues, a-z skip empty cells."""
    cells: list[str] = []
    i = 0
    while i < len(task):
        ch = task[i]
...
def build_case(raw: dict, url: str, fetched_at: str) -> dict:
    ...
    info_bits = [raw["title"] or raw["ident"] or "Hashi"]
    if raw["puzzle_date"]:
